...
display.set_caption('Тест: Какая ты табуретка?')
...
while game:
    ...
    defeat_text = font3.render('Красава, ты просрал катку!', 1, (255,0,0))
    win_text = font3.render('Красава, ты затащил катку!', 1, (0,255,0))
